...
export default function PizzaMenu() {
  ...
  const [addOns, setAddOns] = useState([
    { name: "EXTRA CHEESE", price: 25, quantity: 0 },
    { name: "PEPPERONI SLICES", price: 40, quantity: 0 },
    { name: "VEGETABLE TOPPING", price: 30, quantity: 0 },
    { name: "BARBECUE SAUCE", price: 15, quantity: 0 },
    { name: "STUFFED CRUST", price: 35, quantity: 0 },
  ])
  ...
  const calculateTotal = () => {
    ...
    return selectedPizza ? selectedPizza.price + addOnsTotal : 0
  }
    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="relative h-[40vh] md:h-screen md:w-1/2 lg:w-3/5">
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end p-8">
          <div>
            <h1 className="text-5xl font-bold text-white mb-2">PIZZAS</h1>
            <p className="text-xl text-gray-200">Artisanal oven-baked creations</p>
          </div>
        </div>
        <img src={pizzaImage} alt="Pizza Dish" className="object-cover w-full h-full" />
      </div>
      ...
      <div className="flex flex-1 flex-col bg-gray-50 md:h-screen md:overflow-hidden">
        <div className="sticky top-0 bg-gray-50 p-6 pb-4 z-10 shadow-sm">
          ...
          <h2 className="text-3xl font-bold">
            <span className="text-[#ff3131]">Flavors of Asia</span> <span className="text-[#122348]">Pizzas</span>
          </h2>
          <p className="text-gray-600 mt-1">Wood-fired pizzas with global flavors</p>
        </div>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="relative hidden md:block md:w-2/5 h-auto bg-[#122348]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <h2 className="text-3xl font-bold text-white text-center px-4">{selectedPizza?.name} Pizza</h2>
                </div>
              </div>
              ...
              <div className="p-4 md:p-5 w-full md:w-3/5">
                ...
                <div className="md:hidden mb-3">
                  <h2 className="text-xl font-bold text-[#122348]">
                    {selectedPizza?.name} <span className="text-[#ff3131]">Pizza</span>
                  </h2>
                </div>
                
                <p className="text-gray-600 text-sm italic mb-3">{selectedPizza?.description}</p>
                ...
                <div className="mb-3">
                  ...
                  <Textarea
                    placeholder="Any special requests? (e.g., thin crust, extra spicy)"
                    value={customNotes}
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                  ...
                  <Button
                    ...
                    onClick={addToCart}
                    disabled={!selectedPizza || !tableNumber}
                  >
                    ADD TO CART
                  </Button>
                </div>
