...
export default function DoughnutsMenu() {
  ...
  useEffect(() => {
    axios
      .get("https://back-end-res-6emf.onrender.com/api/foods/doughnuts")
  ...
  const addToCart = async () => {
    ...
    const orderData = {
      foodName: selectedDoughnut.name,
      basePrice: selectedDoughnut.price,
    ...
    try {
      ...
      // Update inventory
      await axios.patch(`https://back-end-res-6emf.onrender.com/api/foods/${selectedDoughnut._id}/decrease-quantity`)
      ...
      <div className="flex flex-1 flex-col bg-gray-50 md:h-screen md:overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 pt-2">
          <div className="grid gap-4">
            {doughnutsVarieties.map((item, index) => (
              <div
                key={index}
              ...
              <div className="p-4 md:p-5 w-full md:w-3/5">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                  ...
                  <Button
                    ...
                    onClick={addToCart}
                    disabled={!selectedDoughnut || !tableNumber}
                  >
                    ADD TO CART
                  </Button>
                </div>
