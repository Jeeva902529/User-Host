...
export default function SandwichMenu() {
  ...
  // Fetch Sandwich data
  useEffect(() => {
    axios.get("https://back-end-res-6emf.onrender.com/api/foods/sandwich")
  ...
  const addToCart = async () => {
    ...
    try {
      ...
      await axios.patch(`https://back-end-res-6emf.onrender.com/api/foods/${selectedSandwich._id}/decrease-quantity`)
      setSandwiches(prev => 
        prev.map(sandwich => 
              ...
              <div className="p-4 md:p-5 w-full md:w-3/5">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                  ...
                  <Button
                    ...
                    onClick={addToCart}
                    disabled={!selectedSandwich || !tableNumber}
                  >
                    ADD TO CART
                  </Button>
                </div>
