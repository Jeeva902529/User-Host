...
export default function IceCreamMenu() {
  ...
  const addToCart = async () => {
    ...
    const orderData = {
      foodName: selectedIceCream.name,
      basePrice: selectedIceCream.price,
    ...
    try {
      ...
      setIceCreams((prev) =>
        prev.map((iceCream) =>
          iceCream._id === selectedIceCream._id
    ...
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      <div className="relative h-[40vh] md:h-screen md:w-1/2 lg:w-3/5">
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end p-8">
          <div>
            <h1 className="text-5xl font-bold text-white mb-2">ICE CREAM</h1>
              ...
              <div className="relative hidden md:block md:w-2/5 h-auto bg-[#122348]">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <h2 className="text-3xl font-bold text-white text-center px-4">
                    {selectedIceCream?.name} Ice Cream
                  </h2>
                </div>
              </div>
